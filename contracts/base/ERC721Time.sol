 ...
 * {ERC721Enumerable}.
 */
abstract contract ERC721Time is Context, ERC165, IERC721Metadata {
     ...
     *
     * @param tokenName The name to set.
     * @param tokenSymbol The symbol to set.
     */
    function __ERC721_Init(string memory tokenName, string memory tokenSymbol)
        internal
    {
        _name = tokenName;
        _symbol = tokenSymbol;
